 ...
 * 
 */
package com.learning.javalearning.netty.file;
...
public class FileClient {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		String path = Thread.currentThread().getContextClassLoader().getResource("in.txt").getFile();
		new FileClient("localhost", 8082, path).run();
	}
